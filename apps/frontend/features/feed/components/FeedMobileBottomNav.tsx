...
const navPathFillHover =
  "transition-all duration-200 ease-in-out group-hover:fill-[var(--color5)] group-hover:fill-opacity-100"
...
export function FeedMobileBottomNav() {
  ...
  return (
    <div className="_mobile_navigation_bottom_wrapper fixed right-0 bottom-0 left-0 z-[1030] hidden max-[991px]:block bg-[var(--bg2)] px-[19px] py-5 dark:bg-[var(--bg5)]">
      <div className="_mobile_navigation_bottom_wrap">
        <ul className="_mobile_navigation_bottom_list m-0 flex list-none items-center justify-between p-0">
          <li className="_mobile_navigation_bottom_item shrink-0">
            <Link
              href="/feed"
              className={cn(
                "_mobile_navigation_bottom_link group relative inline-flex transition-all duration-200 ease-in-out outline-none focus-visible:ring-2 focus-visible:ring-[var(--color5)]/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg2)] dark:focus-visible:ring-offset-[var(--bg5)]",
                homeActive && "_mobile_navigation_bottom_link_active",
              )}
              ...
              >
                <path
                  className={cn(
                    "_mobile_svg",
                    navPathFillHover,
                    "group-hover:stroke-[var(--color5)]",
                    homeActive
                      ? "fill-[var(--color5)] stroke-[var(--color5)] [fill-opacity:1]"
                      : "fill-[var(--feed-mobile-nav-inactive)] stroke-[#666666] dark:stroke-[var(--feed-explore-icon)]",
                  )}
                  strokeWidth="1.5"
                ...
                <path
                  className={cn(
                    ...
                    "group-hover:stroke-[var(--color5)]",
                    homeActive
                      ? "fill-[var(--color5)] stroke-[var(--color5)]"
                      : "fill-[var(--html-white)] stroke-[var(--html-white)]",
                  )}
                  strokeLinecap="round"
          ...
          <li className="_mobile_navigation_bottom_item shrink-0">
            <Link
              href="#0"
              className="_mobile_navigation_bottom_link group relative inline-flex transition-all duration-200 ease-in-out outline-none focus-visible:ring-2 focus-visible:ring-[var(--color5)]/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg2)] dark:focus-visible:ring-offset-[var(--bg5)]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="27"
              ...
              >
                <path
                  className={cn("_dark_svg", navPathFillHover)}
                  fill="var(--feed-mobile-nav-inactive)"
                  fillRule="evenodd"
          ...
          <li className="_mobile_navigation_bottom_item shrink-0">
            ...
            >
              ...
              <span
                className={cn(
                  "_counting absolute top-[-4px] right-[-4px] flex h-[17px] min-h-[17px] min-w-[17px] items-center justify-center rounded-[9px] border bg-[var(--color5)] px-[3px] text-center text-[11px] leading-[1.4] font-normal text-[var(--bg2)]",
                  "border-[var(--bg2)] dark:border-[#112032]",
                )}
              >
                6
              </span>
          ...
          <li className="_header_mobile_toggle flex shrink-0 list-none items-center">
            <Button
              type="button"
              variant="ghost"
              size="icon"
              className="_header_mobile_btn_link size-auto min-h-0 rounded-none border-0 bg-transparent p-0 text-[#666666] shadow-none hover:bg-transparent dark:text-[var(--bg2)] dark:hover:bg-transparent [&_svg]:size-[18px] [&_svg]:!h-3.5 [&_svg]:!w-[18px] focus-visible:ring-2 focus-visible:ring-[var(--color5)]/35"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
